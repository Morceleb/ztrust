                ...
                <div class="info-grid">
                    <div class="col">
                        ...
                        <div class="kv">
                            ...
                            <div class="v">
                                {{ user.username }}
                                <button class="edit-icon" @click="openEditField('username')" title="编辑">
            ...
            <div class="modal">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>{{ fieldLabel }} <span v-if="editingField === 'username'" class="required">*</span></label>
                        <input
...
const user = ref({
    ...
    updated_at: '2026-03-10 14:20:00'
})
...
const userInitial = computed(() => (user.value.username ? user.value.username.charAt(0).toUpperCase() : '?'))
...
const handleAvatarChange = (event) => {
    ...
    reader.onload = (e) => {
        ...
        user.value.updated_at = new Date().toLocaleString('zh-CN', {
            year: 'numeric',
            month: '2-digit',
            day: '2-digit',
            hour: '2-digit',
...
const openEditField = (field) => {
    ...
    editForm.value = {
        value: field === 'username' ? user.value.username :
