    ...
    <div class="layout-container" :class="{
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-menu">
                <ul>
                    <li class="nav-item"
                        :class="{ active: $route.path === '/' || $route.path === '/index' || $route.path === '/login' }">
                        <router-link :to="isAuthenticated ? '/' : '/login'" class="nav-link">
                            ...
                            <span>{{ isAuthenticated ? '工作台' : '登录' }}</span>
                        </router-link>
                    </li>
            ...
            <div v-if="isAuthenticated" class="user-profile-wrapper" @mouseenter="showUserMenu = true"
                ...
                <div class="user-profile">
                    <div class="avatar-wrapper" :title="currentUser.displayName">
